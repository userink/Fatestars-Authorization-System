        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">用户日志</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="index.php"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item active" aria-current="page">用户日志</li>
                </ol>
              </nav>
            </div>
...
<form action="log.php" method="GET" class="form-inline"><input type="hidden" name="my" value="search">
  <div class="form-group">
    <label>搜索&nbsp&nbsp</label>&nbsp&nbsp
	<select name="column" class="form-control"><option value="uid">操作用户</option><option value="type">操作类型</option><option value="data">操作数据</option></select>&nbsp&nbsp
  </div>
  <div class="form-group">
...
?>
      <div class="table-responsive">
              <table class="table align-items-center table-flush">
                <thead class="thead-light"><tr><th scope="col" class="sort" data-sort="user">操作用户</th><th scope="col" class="sort" data-sort="type">操作类型</th><th scope="col" class="sort" data-sort="time">时间</th><th scope="col" class="sort" data-sort="city">城市</th><th scope="col" class="sort" data-sort="data">数据</th></tr></thead>
          <tbody>
<?php
$pagesize=30;
...
if ($page>1)
{
echo '<li><a href="log.php?page='.$first.$link.'"><button type="button" class="btn btn-primary">首页</button></a></li>';
echo '<li><a href="log.php?page='.$prev.$link.'"><button type="button" class="btn btn-secondary">&laquo;</button></a></li>';
} else {
...
for ($i=1;$i<$page;$i++)
echo '<li><a href="log.php?page='.$i.$link.'"><button type="button" class="btn btn-default">'.$i .'</button></a></li>';
...
if ($page<$pages)
{
echo '<li><a href="log.php?page='.$next.$link.'"><button type="button" class="btn btn-secondary">&raquo;</button></a></li>';
echo '<li><a href="log.php?page='.$last.$link.'"><button type="button" class="btn btn-danger">尾页</button></a></li>';
} else {
