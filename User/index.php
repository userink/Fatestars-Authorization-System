          ...
          <div class="row">
              ...
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">全站授权</h5>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">我的授权</h5>
                      <span class="h2 font-weight-bold mb-0">已有<?php echo $gls ?>个</span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">全站用户</h5>
                      <span class="h2 font-weight-bold mb-0">存在<?php echo $numrows ?>个</span>
                    </div>
                    <div class="col-auto">
          ...
          <!-- Basic with list group -->
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="//q4.qlogo.cn/headimg_dl?dst_uin=<?php echo $udata['qq']?>&amp;spec=100" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
              <div class="d-flex justify-content-between">
                <a href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['qq']?>&site=qq&menu=yes" class="btn btn-sm btn-info mr-4">联系站长</a>
                ...
                <a href="#" class="btn btn-sm btn-default float-right"><?php echo $p; ?></a>
              </div>
            </div>
                ...
                <div class="col">
                  <div class="card-profile-stats d-flex justify-content-center">
                    ...
                    <div>
                      ...
                      <span class="description">全站授权</span>
                    </div>
                    <div>
                      <span class="heading"><?php echo $gls ?></span>
                      <span class="description">我的授权</span>
                    </div>
                  </div>
                </div>
                        </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="timeline timeline-one-side" data-timeline-content="axis" data-timeline-axis-style="dashed">
                  ...
                  <?php
$rs=$DB->query("SELECT * FROM auth_gglist  order by id desc limit 2");
...
<a href="./gglist.php" class="dropdown-item text-center text-primary font-weight-bold py-3">查看全部</a>
     </div>
        </div>  
</div>  
