          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="timeline timeline-one-side" data-timeline-content="axis" data-timeline-axis-style="dashed">
                  ...
                  <?php
$rs=$DB->query("SELECT * FROM auth_gxlist  order by id desc ");
while($conf = $DB->fetch($rs))
{
echo'<div class="timeline-block">
                  ...
                  <div class="timeline-content">
                    <small class="text-muted font-weight-bold"> '.$conf['time'].' </small>
                    <h5 class=" mt-3 mb-0">'.$conf['title'].' </h5>
                    <p class=" text-sm mt-1 mb-0"> '.$conf['content'].'</p>
                    <div class="mt-3"> 
                    <span class="badge badge-pill badge-success">'.$conf['tag'].'</span>
                    </div>
                  </div>
                </div>'; 
}
        ...
        <div class="col-lg-6">
          <div class="card bg-gradient-default shadow">
            ...
            <div class="card-body">
              <div class="timeline timeline-one-side" data-timeline-content="axis" data-timeline-axis-style="dashed">
                  <?php
$rs=$DB->query("SELECT * FROM auth_gglist  order by id desc");
while($conf = $DB->fetch($rs))
{
echo'
                <div class="timeline-block">
                  ...
                  <div class="timeline-content">
                    <small class="text-light font-weight-bold"> '.$conf['time'].' </small>
                    <h5 class="text-white mt-3 mb-0">'.$conf['title'].'</h5>
                    <p class="text-light text-sm mt-1 mb-0">'.$conf['content'].'</p>
                    <div class="mt-3">
                      <span class="badge badge-pill badge-success">'.$conf['tag'].'</span>
                    </div>
                  </div>
